        ...
        <>
            ...
            <Card className="prujinabikrligiinfo">
                <CardBody className="infoBody">
                    ...
                    <Button className="text-white infobutton" color="secondary"><Link className="infolink" to="/termometryordamidahavovasuyuqliktemperaturalari">Labaratoriyaga qaytish</Link></Button>
                </CardBody>
            </Card>
        </>
    )
